...
├── majors/
│   ├── 物化生可报专业.md         — 6大方向+推荐排序（含2026麦可思蓝皮书数据）
│   └── 物化地可报专业.md         — 16大类705个专业+物化地vs物化生对比
└── industry/
...
| v2.2 | P0人设全面升级(学长+参谋) + 全链路注入知识 + 成绩去重 + 配置导入导出修复 | ✅ |
| v2.3 | 全链路速度优化 + 缓存机制 + 报告列表/导出 + A1/A4模型调优 + P0专业引导 | ✅ |
| v2.4 | 知识库全面更新：2026教育部专业目录+麦可思蓝皮书+十五五就业规划+物化地清单 | ✅ |
| v2.5 | CSV横向格式解析+选科动态化（物化生/物化地自动适配）+全科目波动检测+prompts.js函数化 | ✅ |
